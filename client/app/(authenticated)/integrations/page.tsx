    ...
    <div className="relative min-h-screen p-8">
      {testResult && (
        <div className="fixed left-1/2 top-8 z-50 -translate-x-1/2 animate-in fade-in slide-in-from-top-4">
          <div
            className={`flex items-center gap-3 rounded-full border px-6 py-3 shadow-2xl backdrop-blur-xl ${
      ...
      {integrations && integrations.length === 0 ? (
        <button
          type="button"
          onClick={() => setIsModalOpen(true)}
          className="flex min-h-[300px] w-full flex-col items-center justify-center rounded-3xl border border-white/5 bg-white/5 p-12 text-center backdrop-blur-xl transition-all hover:border-white/10 hover:bg-white/10"
        >
